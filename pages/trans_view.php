                ...
                <div class="col-sm-4 py-1">
                  ...
                  <table width="100%">
                    <tr>
                      ...
                      <td class="text-right">Ksh <?php echo $sub; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Less VAT</td>
                      <td class="text-right">Ksh <?php echo $less; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Net of VAT</td>
                      <td class="text-right">Ksh <?php echo $net; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Add VAT</td>
                      <td class="text-right">Ksh <?php echo $add; ?></td>
                    </tr>
                    <tr>
                      <td class="font-weight-bold">Total</td>
                      <td class="font-weight-bold text-right text-primary">Ksh <?php echo $grand; ?></td>
                    </tr>
                  </table>
                </div>
